...
const ExploreRooms = () => {
  ...
  <h2 className="text-sm sm:text-base md:text-lg text-gray-700 font-medium leading-relaxed text-center max-w-4xl mx-auto">
    Choose from two options — join an existing room based on your interest, or create your own and invite others. <br /><br />
    After selecting an option, you’ll be prompted to pick your area of interest. Based on your choice, ConnectMe will either create a room for you or show you active rooms you can join.
  </h2>
</div>

<div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 sm:px-6 pt-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Start a new room tailored to your interests and invite others to join.
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Explore and join active rooms with people who share your interests.
          </p>
        </div>
      </div>
    </div>
